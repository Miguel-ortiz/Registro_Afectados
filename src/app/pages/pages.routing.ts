...
import { RegistrarEventosComponent } from './registrar-eventos/registrar-eventos.component';
...
export const routes: Routes = [
    {
        ...
        children:[
           ...
           // { path: 'maps', loadChildren: 'app/pages/maps/maps.module#MapsModule', data: { breadcrumb: 'Maps' } },
            ...
            { path: 'listar-eventos', component: ListarEventosComponent, data: { breadcrumb: 'Eventos' } },
            { path: 'registar-eventos', component: RegistrarEventosComponent, data: { breadcrumb: 'Registrar' } },
